...
<body>
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">@lang('navbar.About')</h1>
            <div class="d-inline-flex mb-lg-5">
                <p class="m-0 text-white"><a class="text-white" href="/">@lang('navbar.Home')</a></p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">@lang('navbar.About')</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="section-title">
                ...
                <h1 class="display-4">Serving Since 1923</h1>
            </div>
            <div class="row">
                <div class="col-lg-4 py-0 py-lg-5">
                    <h1 class="mb-3">@lang('home.Our_Story')</h1>
                    <p>@lang('home.story')</p>
                    <h5 class="mb-3">Bizimle kahve içmeye uğradığınız için teşekkür ederiz!</h5>
